...
import { LegalContainer, LegalHeader, LegalBody, LegalTitle, LegalText, LegalParagraph } from './styles'
const Legal = () => {
  return (
       <LegalContainer>
            <LegalHeader>
                <LegalTitle>Aviso Legal</LegalTitle>
            </LegalHeader>
            <LegalHeader>
                <LegalTitle>Ley de los servicios de la sociedad de la información (LSSI) </LegalTitle>
            </LegalHeader>
            <LegalBody>
                <LegalText>
                    <LegalParagraph>
                        ...
                        EventVerse, se reserva el derecho de modificar cualquier tipo de información que pudiera aparecer en el sitio web, sin que exista obligación de preavisar o poner en conocimiento de los usuarios dichas obligaciones, entendiéndose como suficiente con la publicación en el sitio web de EventVerse
                    </LegalParagraph>
                </LegalText>
            </LegalBody>
            <LegalHeader>
                <LegalTitle>Objeto</LegalTitle>
            </LegalHeader>
            <LegalBody>
                <LegalText>
                    <LegalParagraph>
            ...
            <LegalHeader>
                <LegalTitle>Privacidad y tratamiento de datos</LegalTitle>
            </LegalHeader>
            <LegalBody>
                <LegalText>
                    <LegalParagraph>
                        ...
                        la sección de Política de Privacidad.
                    </LegalParagraph>
                </LegalText>
            </LegalBody>
            <LegalHeader>
                <LegalTitle>Propiedad industrial e intelectual</LegalTitle>
            </LegalHeader>
            <LegalBody>
                <LegalText>
                        <LegalParagraph>
            ...
            <LegalBody>
                <LegalText>
                        <LegalParagraph>
                            Para utilizar algunos de los Servicios, el Usuario debe proporcionar previamente ciertos datos de carácter personal.
                            La empresa tratará automatizadamente estos datos y aplicará las correspondientes medidas de seguridad, todo ello en cumplimiento del RGPD, LOPDGDD y LSSI.
                            El Usuario puede acceder a la política seguida en el tratamiento de los datos personales, así como el establecimiento de las finalidades previamente establecidas, en las condiciones definidas en la Política de Privacidad.
                        </LegalParagraph>
                </LegalText>
            </LegalBody>
            <LegalHeader>
                <LegalTitle>Declaraciones y garantías</LegalTitle>
            </LegalHeader>
            <LegalBody>
                <LegalText>
                        <LegalParagraph>
                           En general, los contenidos y servicios ofrecidos en el Espacio Web tienen carácter meramente informativo.
                           Por consiguiente, al ofrecerlos, no se otorga garantía ni declaración alguna en relación con los contenidos y servicios ofrecidos en el Espacio web,
                           incluyendo, a título enunciativo, garantías de licitud, fiabilidad, utilidad, veracidad, exactitud, o comerciabilidad, salvo en la medida en que por ley no puedan excluirse tales declaraciones y garantías.
                        </LegalParagraph>
                </LegalText>
            </LegalBody>
              <LegalHeader>
                <LegalTitle>Fuerza mayor</LegalTitle>
            </LegalHeader>
            <LegalBody>
                <LegalText>
                        <LegalParagraph>
                           La empresa no será responsable en todo en caso de imposibilidad de prestar servicio, si ésta se debe a interrupciones prolongadas del suministro eléctrico,
                           líneas de telecomunicaciones, conflictos sociales, huelgas, rebelión, explosiones, inundaciones, actos y omisiones del Gobierno, y en general todos los supuestos
                           de fuerza mayor o de caso fortuito.
                        </LegalParagraph>
                </LegalText>
            </LegalBody>
              <LegalHeader>
                <LegalTitle>Resolución de controversias. Ley aplicable y jurisdicción</LegalTitle>
            </LegalHeader>
            <LegalBody>
                <LegalText>
                        <LegalParagraph>
                           Las presentes Condiciones Generales de Uso, así como el uso del Espacio Web, se regirán por la legislación española.
                           Para la resolución de cualquier controversia las partes se someterán a los Juzgados y Tribunales del domicilio social del Responsable del sitio web.
                        </LegalParagraph>
                         <LegalParagraph>
                           En el supuesto de que cualquier estipulación de las presentes Condiciones Generales de Uso resultara inexigible o nula en virtud de la legislación aplicable o como
                           consecuencia de una resolución judicial o administrativa, dicha inexigibilidad o nulidad no hará que las presentes Condiciones Generales de Uso resulten inexigibles o nulas en su conjunto.
