  ...
  const renderPaymentMethod = useMemo(() => {
    ...
    if (paymentMethod === PaymentMethod.CREDIT_CARD) {
      return ticket.crossmint_id
        ? <CrossmintButton data-testid="crossmint-button" clientId={ticket.crossmint_id} quantity={amount} totalPrice={totalPrice} ticketId={ticket.id} userAddress={userAddress} />
